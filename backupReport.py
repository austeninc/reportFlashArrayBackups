...
def format_table(heading, headingStyle, htmlInput):
    ...
    if headingStyle == 1:
        headingHTML = heading.replace('<h1>',
                                        '\n<h1 style="color: white; width: 100%; font-family: Arial, sans-serif; font-size: 2.1em;">')
    elif headingStyle == 2:
        headingHTML = heading.replace('<h2>',
                                        '\n<h2 style="color: white; width: 100%; font-family: Arial, sans-serif; font-size: 1.6em;">')
    else:
        headingHTML = heading.replace('<h3>',
                                        '\n<h3 style="color: white; width: 100%; font-family: Arial, sans-serif; font-weight: 200; font-size: 1.3em;">')

    html = htmlInput.replace('<table border="1" class="dataframe">',
                                '<table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; font-size: 1em;">')
...
def main():
    ...
    for site, dfs in nested_site_dfs.items():
        ...
        if (siteConnectionStatus == "Warning") | (siteActiveDRStatus == "Warning") | (siteActiveClusterStatus == "Warning"):
            ...
            headingHTML = "<br /><h1 style=\"color: white; width: 100%; font-family: Arial, sans-serif; font-size: 2.1em;\">" + heading + "</h1>"
            html = ""
