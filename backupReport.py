...
def report_time(print):
    ...
    if print:
        ...
        print("Report Generated at:", reportTime, "Pacific (UTC-0700)")
        return reportTime
    else:
        return reportTime
